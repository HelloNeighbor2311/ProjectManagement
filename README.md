...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 5070fa60-7dd1-4ef1-969d-a43d436d67ca
```

> `5070fa60-7dd1-4ef1-969d-a43d436d67ca` is the password of the certificate, you can change it to any password you want.
...
Run `ProjectManagement.DbMigrator` to create the initial database. This should be done in the first run. It is also needed if a new database migration is added to the solution later.
