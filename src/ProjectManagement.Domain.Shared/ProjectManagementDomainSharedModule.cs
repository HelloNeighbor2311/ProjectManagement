...
public class ProjectManagementDomainSharedModule : AbpModule
{
    ...
    {
        ProjectManagementGlobalFeatureConfigurator.Configure();
        ProjectManagementModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        Configure<AbpLocalizationOptions>(options =>
        {
            ...
            options.DefaultResourceType = typeof(ProjectManagementResource);
        });
